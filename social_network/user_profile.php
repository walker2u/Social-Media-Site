				...
				<?php 
					...
					if(isset($_GET['u_id'])){
							...
							<div class='row'>
								...
								<center>
									<div style='background-color:#e6e6e6' class='col-sm-3'>
										...
										<img class='img-circle' src='users/$image' width='150px' height='150'><br><br>
										<ul>
						...
						if($user_id == $userown_id){
							...
							<a href='edit_profile.php?u_id=$userown_id' class='btn btn-success'>Edit Profile</a><br><br><br>
				...
				<div class="col-sm-8">
					...
					<?php 
							...
							if($content=="No" && strlen($upload_image) >= 1){
								...
								echo "
									...
									<div id='own_posts'>
										...
										<a href='functions/delete_post.php?post_id=$post_id=$post_id' style='float:right;'><button class='btn btn-danger'>Delete</button></a>
									</div><br><br>
						...
						<div id='own_posts'>
							...
							<a href='single.php?post_id=$post_id' style='float:right;'><button class='btn btn-success'>View</button></a>
							<a href='functions/delete_post.php?post_id=$post_id=$post_id' style='float:right;'><button class='btn btn-danger'>Delete</button></a><br>
						</div><br><br>
