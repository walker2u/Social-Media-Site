	...
	<div class="col-sm-8">
		<form action="" method="post" enctype="multipart/form-data">
			<table class="table table-bordered table-hover">
							...
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal_header">
										...
										<h4 class="modla-title">Modal Header</h4>
									</div>
										...
										<?php 
											if(isset($_POST['sub'])){
												...
												if($bfn == ""){
													...
													echo "<script>alert(window.open('edit_profile.php?u_id=$user_id','_self'))</script>";
													exit();
												}
												else{
				...
				<tr align="center">
					<td colspan="6">
						<button type"submit" class="btn btn-info" name="update" style="width:250px;" value="update">Update</button>
					</td>
				</tr>
			</table>
		</form>
